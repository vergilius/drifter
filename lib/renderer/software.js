...
//                for( indexVertices = 0; indexVertices < currentMesh.vertices.length - 1; indexVertices++ ) {
//                    var pointA = this.project( currentMesh.vertices[ indexVertices ], transformMatrix );
//                    var pointB = this.project( currentMesh.vertices[ indexVertices + 1 ], transformMatrix );
